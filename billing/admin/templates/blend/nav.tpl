        ...
        <li class="has-dropdown">
            ...
            <ul>
                ...
                {if in_array('Apps and Integrations', $admin_perms)}
                    <li>
                        <a id="Menu-Utilities-Sitejet_Builder" href="{routePath('admin-utilities-sitejet-builder-index')}" class="u-position-relative">
    ...
    <ul class="right-nav">
        ...
        <li class="bt account has-dropdown">
            <a id="Menu-Account" href="#" onclick="return false;">
                ...
                {/if}
                <img src="https://www.gravatar.com/avatar/{$gravatarHash}?s=25&d=mp" class="profile-icon" alt="Account"
